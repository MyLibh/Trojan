...
enum class COMMAND_IN_PROGRESS_BITS : std::size_t
{
	DESKTOP_VIEW,
	WEBCAM_VIEW,
...
#define CIP_NUMBER_OF_BITS static_cast<std::size_t>(CIP_BITS::NUMBER_OF_BITS)
...
struct CommandProperties 
{
	...
	using threaded_exec_func_t = std::function<void(const args_t&, cip_t&, std::size_t, boost::asio::io_context&, const boost::asio::ip::udp::endpoint&)>;
...
extern const std::array<CommandProperties, static_cast<std::size_t>(Commands::NUMBER_OF_COMMANDS)> COMMAND_PROPERTIES;

bool _onCmd_MESSAGEBOX       (const args_t &args                                                                                                                  );
void _onCmd_VIEWDESKTOP_START(const args_t &args, cip_t &cip, std::size_t pos, boost::asio::io_context &io_context, const boost::asio::ip::udp::endpoint &endpoint);
...
void _onCmd_VIEWWEBCAM_START (const args_t &args, cip_t &cip, std::size_t pos, boost::asio::io_context &io_context, const boost::asio::ip::udp::endpoint &endpoint);
void _onCmd_VIEWWEBCAM_STOP  (const args_t &    , cip_t &cip, std::size_t pos, boost::asio::io_context &          , const boost::asio::ip::udp::endpoint &        );
